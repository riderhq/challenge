            ...
            $( "#showmore" ).click(function() {
                  var options = {};
                                ...
                                if(!$( "#moredetails" ).is(":visible")){
                                  $( "#moredetails" ).show( "blind", {}, 500, callback );
                                }
                                else{
                                  $( "#moredetails" ).hide( "blind", {}, 500, callback );
                                }
                });
        });
        //update the link so a second click hides the panel
           function callback() {
               if(!$( "#moredetails" ).is(":visible")){
                  $( "#showmore" ).html("<span class='glyphicon glyphicon-chevron-down' aria-hidden='true'></span> &nbsp;More details");
               }
               else{
                  $( "#showmore" ).html("<span class='glyphicon glyphicon-chevron-up' aria-hidden='true'></span> &nbsp;Hide details");
               }
